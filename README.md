# Team 6809 Off Season code
Right now we're working on learning GIT and getting a better handle on programming in general. This is the repository we are using for these practices.
